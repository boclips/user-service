...
class IntegrationControllerTest : AbstractSpringIntegrationTest() {
    ...
    @Test
    fun `creates user and deploymentOrganisation if didn't exist and returns the internal userId _will_be_removed`() {
        ...
        val responseBody = mvc.perform(
            MockMvcRequestBuilders
                .put("/v1/integrations/deployments/deployment-id/users/external-user-id")
