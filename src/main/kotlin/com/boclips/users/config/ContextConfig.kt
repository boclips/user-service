...
class ContextConfig(
    ...
    @Bean
    fun keycloakClient(keycloakWrapper: KeycloakWrapper, organisationMatcher: OrganisationMatcher) = KeycloakClient(
        keycloakWrapper,
        KeycloakUserToIdentityConverter(organisationMatcher)
    )
